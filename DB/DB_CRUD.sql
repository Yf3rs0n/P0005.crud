...
CREATE TABLE inventario_fruta  (
    id_fruta INT IDENTITY(1,1) PRIMARY KEY,
...
INSERT INTO inventario_fruta (nombre_fruta, cantidad, precio_unitario, proveedor, fecha_ingreso)
VALUES 
